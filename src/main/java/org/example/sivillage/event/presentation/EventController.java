...
public class EventController {
    ...
    @Operation(summary = "vendor가 등록한 이벤트 id 리스트 반환")
    @GetMapping("/vendor/ids/{memberUuid}")
    ...
    @Operation(summary = "이벤트 이미지 리스트 조회", description = "이벤트 이미지를 조회합니다.")
    ...
    @GetMapping("/{eventId}/member/thumbnail")
    ...
    @DeleteMapping("/vendor/images/{eventImageId}")
    ...
    @GetMapping("/{eventId}/product-codes")
    ...
    @Operation(summary = "이벤트에 상품 등록", description = "이벤트에 상품을 등록합니다.")
    @PostMapping("/vendor/{eventId}/products")
    ...
    @Operation(summary = "이벤트에 등록된 상품 삭제", description = "이벤트에서 상품을 삭제합니다.")
    @DeleteMapping("/vendor/products")
